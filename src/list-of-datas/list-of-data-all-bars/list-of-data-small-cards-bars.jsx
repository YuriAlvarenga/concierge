...
const dataOfSmallCardsFromBars = 
    [
        {id: 1, title: 'Ao vivo',icon:<FontAwesomeIcon icon={faUserGroup} />,  gradient: ' #B22222'},
        { id: 2, title: 'Pagode', icon: <MusicNoteIcon sx={{color:'#FFF'}}/>, gradient: 'linear-gradient(to bottom, #B22222, #B22222)'},
        { id: 3, title: 'Sertanejo', icon: <MusicNoteIcon sx={{color:'#FFF'}}/>, gradient: 'linear-gradient(to bottom, #ff6888, #ff6888)' },
        { id: 4, title: 'Brasilidade', icon: <MusicNoteIcon sx={{color:'#FFA500'}}/>, gradient: 'linear-gradient(to bottom, green 50%, #FFA500)' },
        { id: 5, title: 'Hip-Hop', icon: <FontAwesomeIcon icon={faMicrophone}/>, gradient: 'linear-gradient(to bottom, #b07eb9, #b07eb9)' },
