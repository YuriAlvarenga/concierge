...
import SmallCard from '../../src/components/cards/hotel-cards/small-card'
  ...
  return (
    ...
    <Box  style={{ maxWidth: '100%', margin: '0 auto' }}>
      <TopBar title={"Hotel Itália"}/>
          ...
          <>
            <Title title={"Baladas"}/>
            <CardComponent gradientColors={['#f588d8, #c0a3e5']} title={"Shed Bar"} horario={"21:00h às 05:00h"} status={"Fechado"}/>
