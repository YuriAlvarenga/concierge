...
import { Box, Grid, Card, CardMedia, Typography, Stack, IconButton } from '@mui/material'
import CheckCircleIcon from '@mui/icons-material/CheckCircle'
import RadioButtonUncheckedIcon from '@mui/icons-material/RadioButtonUnchecked'
import ArrowForwardIcon from '@mui/icons-material/ArrowForward'
import dataOfCarRental from '../../../../list-of-datas/list-of-data-page-home/list-of-data-services/list-of-data-car-rental'

export default function CarRentalCard() {
  return (
    <Grid container spacing={2} style={{ padding: 10, paddingBottom: 0 }}>
      {dataOfCarRental.map(({ id, title: childName, status, image, routePage }) => (
