...
export default function CardAllRestaurants() {
  ...
  const sortedRestaurants = loadedHotel && loadedHotel.restaurants && loadedHotel.restaurants.items
    ? loadedHotel.restaurants.items.sort((a, b) => {
