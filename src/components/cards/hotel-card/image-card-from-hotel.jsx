...
export default function ImageCardFromHotel({hotelName}) {
  ...
  return (
    <Box sx={{mb: 1, overflow: 'hidden' }}>
      <Typography variant="h6" sx={{ position: 'absolute', width: '86%',top:'3%', zIndex:9998, margin:2, color: '#19647e', backgroundColor: 'rgba(255, 255, 255, 0.7)', padding: '12px 16px', borderRadius: '4px'}}><ButtonTranslate color="#19647e" />{hotelName}</Typography>
      <Slider {...settings}>
