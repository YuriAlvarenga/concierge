                ...
                {service.instances && service.instances.map((instance, i) => (
                  ...
                  <Box  sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    {calculateStatus(instance.status) === 'Aberto agora' && (
                        ...
                        <Typography> {instance.status ? calculateStatus(instance.status) : 'Horário não especificado'}</Typography>
                    </Box>
                  </Box>
                )}
                    ...
                    <Box sx={{ position: 'absolute', bottom: 0, left: 0, right: 0, p: 2, color: '#FFF'}}>
                      ...
                      >
                        ...
                        <Stack direction="row" alignItems="center">
                          ...
                          <Typography variant="body2"> {instance.status ? calculateStatus(instance.status) : 'Horário não especificado'}</Typography>
                        </Stack>
                      </Box>
                      )}
